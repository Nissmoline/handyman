<template>
  <main class="service-page">
    <article class="service-container">
      ...
      <section>
        <h2>{{ t('renovationsPage.services.title') }}</h2>
        <ul>
      ...
      <section>
        <h2>{{ t('renovationsPage.whyChoose.title') }}</h2>
        <ul>
      ...
      <div class="contact-buttons">
        <a href="tel:+306949214461" class="btn btn-primary">{{ t('renovationsPage.contact.callNow') }}</a>
        <a href="https://wa.me/306949214461" class="btn btn-secondary">{{ t('renovationsPage.contact.whatsapp') }}</a>
      </div>
